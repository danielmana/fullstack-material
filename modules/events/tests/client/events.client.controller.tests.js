...
(function () {
  ...
  describe('Events Controller Tests', function () {
    ...
    it('$scope.findOne() should create an array with one event object fetched from XHR using a id URL parameter', inject(function (Events) {
      // Set the URL parameter
      $stateParams.id = mockEvent._id;
    ...
    describe('$scope.remove(event)', function () {
      ...
      it('should send a DELETE request with a valid id and remove the event from the scope', inject(function (Events) {
